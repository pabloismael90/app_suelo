...
class BalanceRecorrido extends StatelessWidget {
        ...
        return Container(
            child: ListView(
                children: [
                    ...
                    _botonTemporal(context, suelo, 'Balance nutrientes actual'),
                ],
            ),
    ...
    Widget  _botonTemporal(BuildContext context, TestSuelo suelo, String titulo){
        ...
        return Padding(
            ...
            child: RaisedButton(
                ...
                padding:EdgeInsets.all(13),
                onPressed: () => Navigator.pushNamed(context, 'ResultadoNutrientes', arguments: [suelo, titulo]),
            ),
        );
